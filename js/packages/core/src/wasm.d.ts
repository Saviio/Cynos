...
export interface InitOutput {
    ...
    readonly __wasm_bindgen_func_elem_3686: (a: number, b: number) => void;
    readonly __wasm_bindgen_func_elem_9183: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_3693: (a: number, b: number, c: number) => void;
    readonly __wasm_bindgen_func_elem_1555: (a: number, b: number) => void;
