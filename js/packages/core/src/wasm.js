...
export class SelectBuilder {
    ...
    union(other) {
        try {
            const ptr = this.__destroy_into_raw();
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            _assertClass(other, SelectBuilder);
            wasm.selectbuilder_union(retptr, ptr, other.__wbg_ptr);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            var r2 = getDataViewMemory0().getInt32(retptr + 4 * 2, true);
            if (r2) {
            ...
            return SelectBuilder.__wrap(r0);
        } finally {
            wasm.__wbindgen_add_to_stack_pointer(16);
        }
    }
    ...
    unionAll(other) {
        try {
            ...
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            _assertClass(other, SelectBuilder);
            wasm.selectbuilder_unionAll(retptr, ptr, other.__wbg_ptr);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            var r2 = getDataViewMemory0().getInt32(retptr + 4 * 2, true);
            if (r2) {
...
function __wbg_get_imports() {
    const import0 = {
        ...
        __wbg_new_b5d9e2fb389fef91: function(arg0, arg1) {
            try {
                ...
                var cb0 = (arg0, arg1) => {
                    ...
                    state0.a = 0;
                    try {
                        return __wasm_bindgen_func_elem_9183(a, state0.b, arg0, arg1);
                    } finally {
                        state0.a = a;
                    }
                };
        ...
        __wbindgen_cast_0000000000000001: function(arg0, arg1) {
            ...
            const ret = makeMutClosure(arg0, arg1, wasm.__wasm_bindgen_func_elem_88, __wasm_bindgen_func_elem_1555);
            return addHeapObject(ret);
        },
        __wbindgen_cast_0000000000000002: function(arg0, arg1) {
            // Cast intrinsic for `Closure(Closure { dtor_idx: 300, function: Function { arguments: [Externref], shim_idx: 301, ret: Unit, inner_ret: Some(Unit) }, mutable: true }) -> Externref`.
            const ret = makeMutClosure(arg0, arg1, wasm.__wasm_bindgen_func_elem_3686, __wasm_bindgen_func_elem_3693);
            return addHeapObject(ret);
        },
...
function __wasm_bindgen_func_elem_3693(arg0, arg1, arg2) {
    wasm.__wasm_bindgen_func_elem_3693(arg0, arg1, addHeapObject(arg2));
}

function __wasm_bindgen_func_elem_9183(arg0, arg1, arg2, arg3) {
    wasm.__wasm_bindgen_func_elem_9183(arg0, arg1, addHeapObject(arg2), addHeapObject(arg3));
}
